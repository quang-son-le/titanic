...
print(model.summary())
model.fit(x = df_all[['Deck']].to_numpy(), y=df_all[['Pclass','Fare']].to_numpy() , epochs = 50, batch_size = 4,verbose=0)
...
intermediate_output = intermediate_layer_model.predict(df_all[['Deck']]).reshape(-1,3)
print(intermediate_output)
n = 3
cols = ['{}_{}'.format('Deck', n) for n in range(1, n + 1)]
print(cols)
